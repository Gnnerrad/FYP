...
public class GameDriver {
	...
	private void driver() {
		...
		pvpTest(100, NNSettings.nn, NNSettings.randNN);
		...
		// System.out.println(epoch + "\t" + (t2 - t1));
		// }
		// td.save();
		// // for (int i = 0; i < 100; i++) {
		// // for (int j = 0; j < 100; j++) {
	...
	private void pvpTest(int noOfGames, String p1NN, String p2NN) {
		for (int z = 0; z < noOfGames; z++) {
			player1Rounds = 0;
			player2Rounds = 0;
			neuralNetworkData1 = new ArrayList<IOTuple>();
			neuralNetworkData2 = new ArrayList<IOTuple>();
			player1 = new Player(1, p1NN, neuralNetworkData1);
			player2 = new Player(2, p2NN, neuralNetworkData2);
	...
	private void playAndSaveGame(boolean selfPlay, String p1NN, String p2NN, GameStructure gm) {
		player1Rounds = 0;
		player2Rounds = 0;
		neuralNetworkData1 = new ArrayList<IOTuple>();
		neuralNetworkData2 = new ArrayList<IOTuple>();
		if (selfPlay) {
			...
			player1 = new RandomPlayer(1, p1NN, neuralNetworkData1);
			player2 = new RandomPlayer(2, p2NN, neuralNetworkData2);
		}
		populateGameModeArrays();
		player1GoesFirst = getRandomBoolean();
