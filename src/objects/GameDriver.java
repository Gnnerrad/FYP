...
//			td.learn(neuralNetworkData2);
			...
			totalTime += time;
			System.out.println(player1Wins+":"+player2Wins+":"+drawCount+"\t"+time+"/"+totalTime+":"+(totalTime/z));
		}
		// System.out.println("time = " + totalTime + "\tdata size " +
		// neuralNetworkData1.size() + "," + neuralNetworkData2.size());
