...
public class legalMoveGenerator {
    public ArrayList<Card> legalMoves(ArrayList<Card> hand,
	    Card cardAlreadyPlayed, boolean trumpableGameMode, int trumpSuit) {
	if (cardAlreadyPlayed == null) {
	    return hand;
	} else if (trumpableGameMode) {
    ...
    private ArrayList<Card> nonTrumpable(ArrayList<Card> hand,
	    Card cardAlreadyPlayed) {
	ArrayList<Card> legalMoves = new ArrayList<Card>();
	for (Card inHand : hand) {
	    if (inHand.getSuit().getCardSuit() == cardAlreadyPlayed.getSuit()
		    .getCardSuit()) {
    ...
    private ArrayList<Card> trumpable(ArrayList<Card> hand,
	    Card cardAlreadyPlayed, int trumpSuit) {
	ArrayList<Card> legalMoves = new ArrayList<Card>();
	for (Card inHand : hand) {
	    if (inHand.getSuit().getCardSuit() == cardAlreadyPlayed.getSuit()
		    .getCardSuit()
