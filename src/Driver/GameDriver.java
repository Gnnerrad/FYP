...
public class GameDriver {
	...
	for (int x = 1000; x < 10001; x += 1000) {
	    NNSettings.nn = "lib2/NNself ";
	    System.out.println(x + " vs " + (x - 1000));
	    pvp(NNSettings.nn + x, NNSettings.nn + (x - 1000), 25);
	    System.out.println("\n");
	    // switch (x) {
	    // case 0:
	    ...
	    // gd.clear();
	    // if (i % 50 == 0)
	    // testGame(NNSettings.nn, 10, "Data 2.0/Selfv100 lr " +
	    // NNSettings.learningRate + " rmse", i);
	    // t2 = System.currentTimeMillis();
	    // System.out.println(i + "\t" + (t2 - t1) + "\t" + ((t2 - start) /
	    // (i + 1)) + "/" + (t2 - start));
	    // td.save();
	    // }
	}
