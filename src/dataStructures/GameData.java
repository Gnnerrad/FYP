...
public class GameData {
	...
	try (BufferedWriter out = new BufferedWriter(new FileWriter(NNSettings.player1GameFile, false))) {
	...
	try (BufferedWriter out = new BufferedWriter(new FileWriter(NNSettings.player2GameFile, false))) {
